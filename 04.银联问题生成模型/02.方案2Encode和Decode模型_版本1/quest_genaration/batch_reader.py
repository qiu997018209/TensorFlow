...
class Batcher(object):
  ...
  def __init__(self, data_path, vocab, hps,
    ...
    self._input_queue = Queue.Queue(QUEUE_NUM_BATCH * self._hps.batch_size)#队列，当有多个线程共享一个东西的时候就可以用它了
  ...
  def NextBatch(self):
    ...
    Returns:
      ...
      enc_input_len: encoder input lengths of the batch.    120
      dec_input_len: decoder input lengths of the batch.    30
